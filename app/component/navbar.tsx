...
function Navbar() {
    ...
    const toggleDropdown = () => { // Added toggle function
...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://kxxclxmmdkyrcsvsptqp.supabase.co/storage/v1/object/public/website/hemstrendzgh/android-chrome-512x512.png" className="h-8" alt="Hems Threndz GH" />
      <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Hems Threndz GH</span>
  </a>
