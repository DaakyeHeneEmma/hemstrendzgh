...
<nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://kxxclxmmdkyrcsvsptqp.supabase.co/storage/v1/object/public/website/hemstrendzgh/android-chrome-192x192.png" className="h-7" alt="Hemstrendz Logo" />
      <span className="self-center text-sm font-semibold whitespace-nowrap dark:text-white">Hems Trendz</span>
  </a>
